...
family derives from two source files:
    ...
    rnetonet/sources/Cascadia_Mono/CascadiaMono.ttf        @ wght=342 (Light..SemiLight)   -> rnetonet-Regular.ttf        (-> 400)
    rnetonet/sources/Cascadia_Mono/CascadiaMono.ttf        @ wght=392 (SemiLight..Regular) -> rnetonet-Bold.ttf           (-> 700)
    rnetonet/sources/Cascadia_Mono/CascadiaMonoItalic.ttf  @ wght=342 (Light..SemiLight)   -> rnetonet-RegularItalic.ttf  (-> 400)
    rnetonet/sources/Cascadia_Mono/CascadiaMonoItalic.ttf  @ wght=392 (SemiLight..Regular) -> rnetonet-BoldItalic.ttf     (-> 700)
...
Regular (usWeightClass 400); wght 392, between SemiLight (350) and Regular (400), ships as its
...
BUILDS = [
    ...
    (ROMAN, 342, "rnetonet-Regular.ttf", "Regular", "Regular", 400, False, False, REGULAR_WGHT, ROMAN_ITAL),
    (ROMAN, 392, "rnetonet-Bold.ttf", "Bold", "Bold", 700, True, False, BOLD_WGHT, ROMAN_ITAL),
    (ITAL, 342, "rnetonet-RegularItalic.ttf", "Italic", "Italic", 400, False, True, REGULAR_WGHT, ITALIC_ITAL),
    (ITAL, 392, "rnetonet-BoldItalic.ttf", "Bold Italic", "BoldItalic", 700, True, True, BOLD_WGHT, ITALIC_ITAL),
]
